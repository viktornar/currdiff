...
/**
 * Sort Item collection in descending order by rateChangeInPercentage.
 *
 * @author v.nareiko
 */
public class RateChangeInPercentageComparator implements Comparator<Item> {
    @Override
    public int compare(Item o1, Item o2) {
        if (o1.getRateChangeInPercentage() > o2.getRateChangeInPercentage()){
            return -1;
        }else{
            return 1;
        }
